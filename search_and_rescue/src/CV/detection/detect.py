...
def opencv():
	pub = rospy.Publisher('cvtosonar',String, queue_size=100)
...
class ShapeDetector:
	...
	def detect(self, c):
		...
		# otherwise, we assume the shape is a circle
			...
			shape = "not a square or rectangle"
	...
	try:	
		...
		while not rospy.is_shutdown():	
			...
			for n in range(count):
				...
				if area<cv2.contourArea(contours[n]):
		...
		#	cv2.drawContours(frame, cnt,-1,(0,255,0),3) 
			...
			height=(peri-np.sqrt((peri**2)-(16*area))/4)
